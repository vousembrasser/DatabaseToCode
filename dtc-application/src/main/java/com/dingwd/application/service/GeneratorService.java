...
import com.dingwd.application.service.template.TemplateService;
...
import com.dingwd.domain.model.ParaMap;
import com.dingwd.domain.model.ProjectInfo;
import com.dingwd.domain.var.ClassParam;
...
public class GeneratorService {
    ...
    public void execute(Map<String, String> additionalParameters) {
        ...
        List<TableInfo> tables = tableInfoService.getTablesInfo(generatorInfo.getTableNames(),
